import { CircleCheck, Truck, Heart, Users } from 'lucide-react';
...
const SIDE_CARDS = [
    {
        ...
        description: 'Immediate aid delivered to families affected by crisis and hardship.',
        Icon: Truck,
    },
    {
        title: 'Essential Support',
        description: 'Providing food, shelter items, and basic necessities during emergencies.',
        Icon: Heart,
    },
    {
        title: 'Community Recovery',
        description: 'Helping vulnerable communities recover with dignity and care.',
        Icon: Users,
    },
];
                ...
                */}
                <div className="relative mx-auto w-full max-w-4xl px-5 sm:px-8 text-center animate-fade-up">
                    ...
                    <p className="mt-5 text-base sm:text-lg leading-relaxed text-muted-foreground max-w-2xl mx-auto">
                        Rapid support for families and communities during urgent crises.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid w-full max-w-full gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] items-start">
                        ...
                        <div className="rounded-[32px] border border-border/60 bg-card p-6 sm:p-7 shadow-capsule">
                            ...
                            <h2 className="mt-5 font-display text-3xl sm:text-4xl font-semibold leading-tight text-primary">
                                Respond quickly when families need urgent help
                            </h2>

                            <p className="mt-5 text-base leading-relaxed text-muted-foreground">
                                Our Emergency Relief program provides urgent assistance to families affected by
                                crises, disasters, and difficult circumstances. Support may include food, shelter,
                                basic essentials, and immediate care.
                            </p>
