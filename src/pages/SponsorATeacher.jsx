...
const SIDE_CARDS = [
    {
        ...
        description: 'Supporting educators with professional training and development opportunities.',
        Icon: GraduationCap,
    },
    {
        title: 'Teaching Resources',
        description: 'Providing essential books, materials, and resources for effective teaching.',
        Icon: BookOpen,
    },
    {
        title: 'Classroom Support',
        description: 'Helping teachers create supportive learning environments for their students.',
        Icon: Users,
    },
];

export default function SponsorATeacher() {
    return (
                    ...
                    <div className="grid w-full max-w-full gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] items-start">
                        ...
                        <div className="rounded-[32px] border border-border/60 bg-card p-6 sm:p-7 shadow-capsule">
                            <div className="mb-7 overflow-hidden rounded-[28px] border border-border/60 shadow-soft">
                                <img
                                    src={sponsorTeacherImg}
                                    alt="Sponsor a Teacher"
                            ...
                            */}
                            ...
                            <h2 className="mt-5 font-display text-3xl sm:text-4xl font-semibold leading-tight text-primary">
                                Your support strengthens the hands that shape the future
                            </h2>

                            <p className="mt-5 text-base leading-relaxed text-muted-foreground">
                                Our teachers are at the heart of every successful classroom. Your support helps us
                                provide them with training, resources, and a stable environment so they can
                                continue shaping young minds with dedication and passion.
                            </p>
