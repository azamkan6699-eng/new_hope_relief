import { CircleCheck, Package, Users, Heart } from 'lucide-react';
...
const SIDE_CARDS = [
    {
        ...
        description: 'Staple items prepared to support families with their basic daily meals.',
        Icon: Package,
    },
    {
        title: 'Family Support',
        description: 'Designed for vulnerable households facing financial hardship.',
        Icon: Users,
    },
    {
        title: 'Community Relief',
        description: 'Helping communities with dignity, care, and trusted support.',
        Icon: Heart,
    },
];
                ...
                */}
                <div className="relative mx-auto w-full max-w-4xl px-5 sm:px-8 text-center animate-fade-up">
                    ...
                    <p className="mt-5 text-base sm:text-lg leading-relaxed text-muted-foreground max-w-2xl mx-auto">
                        Monthly food packs and essential support for families in need.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid w-full max-w-full gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] items-start">
                        ...
                        <div className="rounded-[32px] border border-border/60 bg-card p-6 sm:p-7 shadow-capsule">
                            ...
                            <h2 className="mt-5 font-display text-3xl sm:text-4xl font-semibold leading-tight text-primary">
                                Deliver food support to families in need
                            </h2>

                            <p className="mt-5 text-base leading-relaxed text-muted-foreground">
                                The Family Food Pack program provides essential food supplies to vulnerable families
                                facing financial hardship and food insecurity. Each package is prepared to help
                                families meet their basic needs with dignity and care.
                            </p>
